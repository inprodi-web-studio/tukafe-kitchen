...
import sty from "./PlasmicBranch.module.css"; // plasmic-import: ImA7pb2DyG8q/css
import FlechasEnCirculoSvgIcon from "./icons/PlasmicIcon__FlechasEnCirculoSvg"; // plasmic-import: 9eRAu6WYH1k1/icon

createPlasmicElementProxy;

export const PlasmicBranch__VariantProps = new Array();

export const PlasmicBranch__ArgProps = new Array();
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicBranch.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicBranch.pageMetadata.title}
        />
        ...
        >
          ...
          >
            ...
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__cTtSt)}
                displayHeight={"100%"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__zBdn7)}
                displayHeight={"100%"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
          ...
          {(() => {
            ...
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__hb93X)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
